...
if( ! function_exists('mise_show_social_network')){
	function mise_show_social_network($position) {
		...
		<div class="<?php echo $position == 'float' ? 'site-social' : 'site-social-footer' ?>">
			...
			<?php endif; ?>
			<?php if ($imdbURL) : ?>
				<a href="<?php echo esc_url($imdbURL); ?>" target="<?php echo esc_attr($openLinks); ?>" title="<?php esc_attr_e( 'Imdb', 'mise' ); ?>"><i class="fa fa-imdb spaceLeftRight"><span class="screen-reader-text"><?php esc_html_e( 'Imdb', 'mise' ); ?></span></i></a>
			<?php endif; ?>
		</div>
		<?php
	}
