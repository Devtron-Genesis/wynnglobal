...
class Mise_Admin {
	...
	public function welcome_notice() {
		...
		<div id="message" class="updated cresta-message">
			...
			<p class="submit">
				<a class="button-primary" href="<?php echo esc_url( admin_url( 'themes.php?page=mise-welcome' ) ); ?>"><?php esc_html_e( 'Get started with Mise', 'mise' ); ?></a>
				<a class="button-secondary" href="<?php echo esc_url( apply_filters( 'mise_pro_theme_url', admin_url( add_query_arg( array( 'page' => 'mise-welcome', 'tab' => 'documentation/#demoContent' ), 'themes.php' ) ) ) ); ?>"><?php esc_html_e( 'Import demo content (instructions)', 'mise' ); ?></a>
			</p>
		</div>
		<?php
	}
		...
		<div class="cresta-theme-info">
			...
			<div class="welcome-description-wrap">
				...
				<p class="cresta-actions">
					...
					<a href="<?php echo esc_url( apply_filters( 'mise_pro_theme_url', admin_url( add_query_arg( array( 'page' => 'mise-welcome', 'tab' => 'documentation/#demoContent' ), 'themes.php' ) ) ) ); ?>" class="button button-secondary docs"><?php esc_html_e( 'Import demo content (instructions)', 'mise' ); ?></a>
		...
		<div class="wrap about-wrap">
			...
			<div class="option-panel-toggle" id="demoContent">
				<div class="singleToggle">
					<span class="dashicons dashicons-arrow-right"></span><div class="toggleTitle"><?php esc_html_e( 'How to import demo content', 'mise' ); ?></div>
					<div class="toggleText">
						<ul>
							<li>
								<div class="miseDocText">
									<?php esc_html_e( 'First install the "One Click Demo Import" plugin on the website', 'mise' ); ?><br/>
									<a href="<?php echo esc_url( apply_filters( 'click_to_import_plugin_url', 'https://wordpress.org/plugins/one-click-demo-import/' ) ); ?>" class="button button-secondary" target="_blank"><?php esc_html_e( 'One Click Demo Import plugin page', 'mise' ); ?></a>
								</div>
								<div class="miseDocImage">
									<img src="<?php echo esc_url( get_template_directory_uri() ) . '/inc/admin/images/mise-documentation-17.png'; ?>" />
								</div>
							</li>
							<li>
								<div class="miseDocText">
									<?php esc_html_e( 'Once you have installed and activated the plugin, go to your WordPress Dashboard under "Appearance-> Import Demo Data" and click on the "Import Demo Data" button. Please click on the Import button only once and wait, it can take a couple of minutes.', 'mise' ); ?><br/>
									<strong><?php esc_html_e( 'We recommend importing the demo content to new websites without content. This is to avoid filling the website with new pages and posts that could create confusion with existing content. After you import the demo, the main menu, widgets, and some parts of the theme (like the site logo) must be set manually.', 'mise' ); ?></strong>
								</div>
								<div class="miseDocImage">
									<img src="<?php echo esc_url( get_template_directory_uri() ) . '/inc/admin/images/mise-documentation-18.png'; ?>" />
								</div>
							</li>
						</ul>
					</div>
					...
					<div class="toggleText">
						<ul>
							<li>
								...
								<div class="miseDocImage">
									<a href="<?php echo esc_url( apply_filters( 'mise_youtube_video', 'https://www.youtube.com/watch?v=025dPOpSorg' ) ); ?>" target="_blank"><?php esc_html_e( 'Link to the YouTube video', 'mise' ); ?></a>
								</div>
							</li>
							<li>
								<div class="miseDocText">
					...
					<div class="toggleText">
						<ul>
							<li>
								...
								<div class="miseDocImage">
									<a href="<?php echo esc_url( apply_filters( 'mise_youtube_video', 'https://www.youtube.com/watch?v=obK6KjgxhNg' ) ); ?>" target="_blank"><?php esc_html_e( 'Link to the YouTube video', 'mise' ); ?></a>
								</div>
							</li>
							<li>
								<div class="miseDocText">
