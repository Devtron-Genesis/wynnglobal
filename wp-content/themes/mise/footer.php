		...
		<div class="mainFooter">
			...
			<div class="miseFooterInfo">
				<div class="site-info">
					...
					printf( esc_html__( 'WordPress Theme: %1$s by %2$s.', 'mise' ), '<a target="_blank" href="https://crestaproject.com/downloads/mise/" rel="nofollow" title="Mise Theme">Mise</a>', 'CrestaProject' );
					?>
				</div><!-- .site-info -->
				<?php 
